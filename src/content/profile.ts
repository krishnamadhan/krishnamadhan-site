...
export const profile = {
  ...
  skills: [
    { cluster: "Languages", items: ["Java", "Python", "TypeScript"] },
    { cluster: "Web", items: ["React", "Next.js", "Node.js"] },
    { cluster: "Cloud", items: ["AWS", "Terraform", "Spinnaker"] },
    { cluster: "Data", items: ["ETL", "Data Mesh", "Data Quality"] },
    { cluster: "AI", items: ["AI Agents", "Claude Code", "Automation"] },
    { cluster: "Hardware", items: ["Raspberry Pi", "Robotics", "Sensors", "ESP32"] },
    { cluster: "Craft", items: ["System Design", "Reliability", "Platform Engineering"] },
  ],
  life: {
